...
class TransferToSavings extends StatefulWidget {
  final RxBool isSpending;
  TransferToSavings({required this.isSpending, super.key});

  @override
  State<TransferToSavings> createState() => _TransferToSavingsState();
}

class _TransferToSavingsState extends State<TransferToSavings> {

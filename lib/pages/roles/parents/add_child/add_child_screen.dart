          ...
          child: Column(
            ...
            children: [
              ...
              CustomTextField(
                ...
                onChanged: (value) => _controller.childName.value = value.trim(),
              ),
                          ...
                          () => GestureDetector(
                            ...
                            child: Padding(
                              ...
                              child: CircleAvatar(
                                ...
                                backgroundImage: _controller.customAvatarPath.value.isEmpty ? null : FileImage(File(_controller.customAvatarPath.value)),
                        ...
                        return Obx(
                          () => GestureDetector(
                            ...
                            child: Padding(
                              ...
                              child: Container(
                                decoration:
                                    BoxDecoration(border: Border.all(color: _controller.selectedAvatar.value == avatarIndex ? Colors.purple : Colors.green), borderRadius: BorderRadius.circular(50)),
                                child: Image.asset(
                                  _controller.avatars[avatarIndex],

                                  height: 10, // Set the height to fit the container size
              ...
              Center(
                ...
                onPressed: () async {
                  if (!firebaseAuthController.isNormalLoading.value) {
                    ...
                    firestoreOperations.parentFirebaseFunctions.addChildAndUpdateParent();
                  }
                },
                isLoading: false,
              )),
